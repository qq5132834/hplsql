...
public class FunctionMisc extends Function {
  ...
  public void register(Function f) {
    f.map.put("COALESCE", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) { nvl(ctx); }});
    f.map.put("DECODE", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) { decode(ctx); }});
    f.map.put("NVL", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) { nvl(ctx); }});
    f.map.put("NVL2", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) { nvl2(ctx); }});
    f.map.put("PART_COUNT_BY", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) { partCountBy(ctx); }});
    
    f.specMap.put("ACTIVITY_COUNT", new FuncSpecCommand() { public void run(PlsqlParser.Expr_spec_funcContext ctx) { activityCount(ctx); }});
    f.specMap.put("CAST", new FuncSpecCommand() { public void run(PlsqlParser.Expr_spec_funcContext ctx) { cast(ctx); }});
    f.specMap.put("CURRENT", new FuncSpecCommand() { public void run(PlsqlParser.Expr_spec_funcContext ctx) { current(ctx); }});
    f.specMap.put("CURRENT_USER", new FuncSpecCommand() { public void run(PlsqlParser.Expr_spec_funcContext ctx) { currentUser(ctx); }});
    f.specMap.put("PART_COUNT", new FuncSpecCommand() { public void run(PlsqlParser.Expr_spec_funcContext ctx) { partCount(ctx); }});
    f.specMap.put("USER", new FuncSpecCommand() { public void run(PlsqlParser.Expr_spec_funcContext ctx) { currentUser(ctx); }});

    f.specSqlMap.put("CURRENT", new FuncSpecCommand() { public void run(PlsqlParser.Expr_spec_funcContext ctx) { currentSql(ctx); }});
  }
  
  /**
   * ACTIVITY_COUNT function (built-in variable)
   */
  void activityCount(PlsqlParser.Expr_spec_funcContext ctx) {
   ...
   * CAST function
   */
  void cast(PlsqlParser.Expr_spec_funcContext ctx) {
    if (ctx.expr().size() != 1) {
      evalNull();
      return;
    }
   ...
   */
  void current(PlsqlParser.Expr_spec_funcContext ctx) {
    if (ctx.T_DATE() != null) {
   ...
   */
  void currentSql(PlsqlParser.Expr_spec_funcContext ctx) {
    if (ctx.T_DATE() != null) {
   ...
   */
  void currentUser(PlsqlParser.Expr_spec_funcContext ctx) {
    evalVar(currentUser());
  }
   ...
   * DECODE function
   */
  void decode(PlsqlParser.Expr_func_paramsContext ctx) {
   ...
   */
  void nvl(PlsqlParser.Expr_func_paramsContext ctx) {
   ...
   */
  void nvl2(PlsqlParser.Expr_func_paramsContext ctx) {
   ...
   * PART_COUNT function
   */
  public void partCount(PlsqlParser.Expr_spec_funcContext ctx) {
   ...
   */
  public void partCountBy(PlsqlParser.Expr_func_paramsContext ctx) {
    int cnt = ctx.func_param().size();
