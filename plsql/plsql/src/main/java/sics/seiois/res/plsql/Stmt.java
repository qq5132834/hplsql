...
public class Stmt {
   ...
   */
  public Integer allocateCursor(PlsqlParser.Allocate_cursor_stmtContext ctx) {
    ...
    if (ctx.T_PROCEDURE() != null) {
      ...
      if (cur != null && cur.type != Var.Type.RS_LOCATOR) {
        cur = null;
      }
    }
    if (cur == null) {
    ...
    exec.addVariable(new Var(name, Var.Type.CURSOR, cur.value));
    return 0; 
  }
   ...
   */
  public Integer associateLocator(PlsqlParser.Associate_locator_stmtContext ctx) {
   ...
   */
  public Integer declareCursor(PlsqlParser.Declare_cursor_itemContext ctx) {
   ...
   */
  public Integer createTable(PlsqlParser.Create_table_stmtContext ctx) {
   ...
   */
  String createTableDefinition(PlsqlParser.Create_table_definitionContext ctx, Token last) {
    StringBuilder sql = new StringBuilder();
    PlsqlParser.Create_table_columnsContext colCtx = ctx.create_table_columns();
    if (colCtx != null) {
      int cnt = colCtx.create_table_columns_item().size();
      for (int i = 0; i < cnt; i++) {
        PlsqlParser.Create_table_columns_itemContext col = colCtx.create_table_columns_item(i);
    ...
    PlsqlParser.Create_table_optionsContext options = ctx.create_table_options();
    if (options != null) {
   ...
   */
  public Integer createTableHiveOptions(PlsqlParser.Create_table_options_hive_itemContext ctx) {
  ...
  public Integer createTableHiveRowFormat(PlsqlParser.Create_table_hive_row_formatContext ctx) {
    StringBuilder sql = new StringBuilder();
    sql.append("ROW FORMAT DELIMITED");
    int cnt = ctx.create_table_hive_row_format_fields().size();
    for (int i = 0; i < cnt; i++) {
      PlsqlParser.Create_table_hive_row_format_fieldsContext c = ctx.create_table_hive_row_format_fields(i);
      if (c.T_FIELDS() != null) {
   ...
   */
  public Integer createTableMysqlOptions(PlsqlParser.Create_table_options_mysql_itemContext ctx) {
   ...
   */
  public Integer declareTemporaryTable(PlsqlParser.Declare_temporary_table_itemContext ctx) {
   ...
   */
  public Integer createDatabase(PlsqlParser.Create_database_stmtContext ctx) {
    ...
    for (int i = 0; i < cnt; i++) {
      PlsqlParser.Create_database_optionContext option = ctx.create_database_option(i);
   ...
   */
  public Integer createLocalTemporaryTable(PlsqlParser.Create_local_temp_table_stmtContext ctx) {
   ...
   */
  public Integer createTemporaryTable(PlsqlParser.IdentContext identCtx, PlsqlParser.Create_table_definitionContext defCtx,
                                      PlsqlParser.Create_table_preoptionsContext optCtx) {
    StringBuilder sql = new StringBuilder();
   ...
   * DESCRIBE statement
   */
  public Integer describe(PlsqlParser.Describe_stmtContext ctx) {
    trace(ctx, "DESCRIBE");
   ...
   * DROP statement
   */
  public Integer drop(PlsqlParser.Drop_stmtContext ctx) {
    trace(ctx, "DROP");
    String sql = null;    
    if (ctx.T_TABLE() != null) {
      sql = "DROP TABLE ";
   ...
   * TRUNCATE statement
   */
  public Integer truncate(PlsqlParser.Truncate_stmtContext ctx) {
    trace(ctx, "TRUNCATE");
   ...
   */
  public Integer open(PlsqlParser.Open_stmtContext ctx) {
    trace(ctx, "OPEN");
    Query query = null;
    Var var = null;
   ...
   */
  public Integer fetch(PlsqlParser.Fetch_stmtContext ctx) {
    trace(ctx, "FETCH");
   ...
   */
  public Integer close(PlsqlParser.Close_stmtContext ctx) {
    trace(ctx, "CLOSE");
   ...
   * INCLUDE statement
   */
  public Integer include(PlsqlParser.Include_stmtContext ctx) {
    String file;
   ...
   */
  public Integer ifPlsql(PlsqlParser.If_plsql_stmtContext ctx) {
   ...
   */
  public Integer ifTsql(PlsqlParser.If_tsql_stmtContext ctx) {
    trace(ctx, "IF");
    visit(ctx.bool_expr());
   ...
   */
  public Integer ifBteq(PlsqlParser.If_bteq_stmtContext ctx) {
    trace(ctx, "IF");
    visit(ctx.bool_expr());
    if (exec.stackPop().isTrue()) {
      trace(ctx, "IF TRUE executed");
   ...
   */
  public Integer assignFromSelect(PlsqlParser.Assignment_stmt_select_itemContext ctx) {
   ...
   */
  public Integer insert(PlsqlParser.Insert_stmtContext ctx) {
   ...
   */
  public Integer insertSelect(PlsqlParser.Insert_stmtContext ctx) {
   ...
   */
  public Integer insertValues(PlsqlParser.Insert_stmtContext ctx) {
    ...
    for (int i = 0; i < rows; i++) {
      PlsqlParser.Insert_stmt_rowContext row =ctx.insert_stmt_rows().insert_stmt_row(i);
   ...
   */
  public Integer insertDirectory(PlsqlParser.Insert_directory_stmtContext ctx) {
   ...
   */
  public Integer getDiagnosticsException(PlsqlParser.Get_diag_stmt_exception_itemContext ctx) {
   ...
   */
  public Integer getDiagnosticsRowCount(PlsqlParser.Get_diag_stmt_rowcount_itemContext ctx) {
   ...
   * USE statement
   */
  public Integer use(PlsqlParser.Use_stmtContext ctx) {
    trace(ctx, "USE");
   ...
   * VALUES statement
   */
  public Integer values(PlsqlParser.Values_into_stmtContext ctx) {
   ...
   * WHILE statement
   */
  public Integer while_(PlsqlParser.While_stmtContext ctx) {
   ...
   */
  public Integer forCursor(PlsqlParser.For_cursor_stmtContext ctx) {
   ...
   */
  public Integer forRange(PlsqlParser.For_range_stmtContext ctx) {
   ...
   */
  private Var setIndex(int start, int end, PlsqlParser.For_range_stmtContext ctx) {
   ...
   */
  private void updateIndex(int step, Var index, PlsqlParser.For_range_stmtContext ctx) {
   ...
   */
  public Integer exec(PlsqlParser.Exec_stmtContext ctx) {
    if (execProc(ctx)) {
      return 0;
    }
    trace(ctx, "EXECUTE");
   ...
   */
  public Boolean execProc(PlsqlParser.Exec_stmtContext ctx) {
   ...
   */
  public Integer exit(PlsqlParser.Exit_stmtContext ctx) {
    trace(ctx, "EXIT");
    String label = "";
    if (ctx.L_ID() != null) {
   ...
   */
  public Integer break_(PlsqlParser.Break_stmtContext ctx) {
    trace(ctx, "BREAK");
    leaveLoop("");
    return 0;
  }
   ...
   */
  public Integer leave(PlsqlParser.Leave_stmtContext ctx) {
    trace(ctx, "LEAVE");
    String label = "";
    if (ctx.L_ID() != null) {
      label = ctx.L_ID().toString();
   ...
   * UPDATE statement
   */
  public Integer update(PlsqlParser.Update_stmtContext ctx) {
    trace(ctx, "UPDATE");
   ...
   * DELETE statement
   */
  public Integer delete(PlsqlParser.Delete_stmtContext ctx) {
    trace(ctx, "DELETE");
    String table = evalPop(ctx.table_name()).toString();
    StringBuilder sql = new StringBuilder();
    if (ctx.T_ALL() == null) {
   ...
   * MERGE statement
   */
  public Integer merge(PlsqlParser.Merge_stmtContext ctx) {
    trace(ctx, "MERGE");
    String sql = exec.getFormattedText(ctx);
    trace(ctx, sql);
    Query query = exec.executeSql(ctx, sql, exec.conf.defaultConnection);
   ...
   * PRINT Statement 
   */
  public Integer print(PlsqlParser.Print_stmtContext ctx) {
    trace(ctx, "PRINT");
    if (ctx.expr() != null) {
   ...
   * QUIT Statement 
   */
  public Integer quit(PlsqlParser.Quit_stmtContext ctx) {
    trace(ctx, "QUIT");
    String rc = null;
    if (ctx.expr() != null) {
   ...
   * SET current schema 
   */
  public Integer setCurrentSchema(PlsqlParser.Set_current_schema_optionContext ctx) {
   ...
   * SIGNAL statement
   */
  public Integer signal(PlsqlParser.Signal_stmtContext ctx) {
    trace(ctx, "SIGNAL");
   ...
   * SUMMARY statement
   */
  public Integer summary(PlsqlParser.Summary_stmtContext ctx) {
    trace(ctx, "SUMMARY");
    String table = null;
    String select = null;
    String conn = null;
  ...
  public Integer summaryStat(PlsqlParser.Summary_stmtContext ctx, String table, String select,
  ...
  public Integer summaryTop(PlsqlParser.Summary_stmtContext ctx, String table, String select,
     Row row, String conn, Conn.Type connType) {
   ...
   * RESIGNAL statement
   */
  public Integer resignal(PlsqlParser.Resignal_stmtContext ctx) {
    trace(ctx, "RESIGNAL");
   ...
   * RETURN statement
   */
  public Integer return_(PlsqlParser.Return_stmtContext ctx) {
    trace(ctx, "RETURN");
    if (ctx.expr() != null) {
      eval(ctx.expr());
    }
