...
import sics.seiois.res.plsql.File;
...
public class FunctionOra extends Function {
  ...
  public void register(Function f) {  
    f.map.put("DBMS_OUTPUT.PUT_LINE", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) {
      dbmsOutputPutLine(ctx); }});
    f.map.put("UTL_FILE.FOPEN", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) {
      utlFileFopen(ctx); }});
    f.map.put("UTL_FILE.GET_LINE", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) {
      utlFileGetLine(ctx); }});
    f.map.put("UTL_FILE.PUT_LINE", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) {
      utlFilePutLine(ctx); }});
    f.map.put("UTL_FILE.PUT", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) {
      utlFilePut(ctx); }});
    f.map.put("UTL_FILE.FCLOSE", new FuncCommand() { public void run(PlsqlParser.Expr_func_paramsContext ctx) {
      utlFileFclose(ctx); }});
  }
   ...
   */
  void dbmsOutputPutLine(PlsqlParser.Expr_func_paramsContext ctx) {
   ...
   */
  public void utlFileFopen(PlsqlParser.Expr_func_paramsContext ctx) {
    String dir = "";
    String name = "";
    boolean write = true;
   ...
   */
  void utlFileGetLine(PlsqlParser.Expr_func_paramsContext ctx) {
    int cnt = ctx.func_param().size();
    Var file = null;
    Var str = null;
   ...
   */
  public void utlFilePutLine(PlsqlParser.Expr_func_paramsContext ctx) {
   ...
   */
  public void utlFilePut(PlsqlParser.Expr_func_paramsContext ctx) {
   ...
   */
  void utlFilePut(PlsqlParser.Expr_func_paramsContext ctx, boolean newline) {
    int cnt = ctx.func_param().size();
    Var file = null;
    String str = "";
   ...
   */
  void utlFileFclose(PlsqlParser.Expr_func_paramsContext ctx) {
    int cnt = ctx.func_param().size();
    Var file = null;
